...
EXPORT char hover_bless_text[120];
EXPORT char hover_freeze_text[120];
EXPORT char hover_potion_text[120];
EXPORT char hover_rage_text[120];
EXPORT char hover_level_text[120];
EXPORT char hover_rank_text[120];
EXPORT char hover_time_text[120];
