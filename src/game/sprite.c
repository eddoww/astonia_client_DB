...
EXPORT int _is_cut_sprite(int sprite) {
    switch (sprite) {
...
EXPORT int _is_mov_sprite(int sprite,int itemhint) {
    switch (sprite) {
...
EXPORT int _is_door_sprite(int sprite) {
    switch (sprite) {
        case 20039: case 20040: case 20041: case 20042:         // wood door
        case 20122: case 20123: case 20124: case 20125:         // steel door
        case 20152: case 20153: case 20154: case 20155:         // poor wood door
...
EXPORT int _is_yadd_sprite(int sprite) {
    switch (sprite) {
...
EXPORT int _trans_charno(int csprite,int *pscale,int *pcr,int *pcg,int *pcb,int *plight,int *psat,int *pc1,int *pc2,int *pc3,int *pshine,int attick) {
...
EXPORT int _trans_asprite(int mn,int sprite,int attick,unsigned char *pscale,unsigned char *pcr,unsigned char *pcg,unsigned char *pcb,unsigned char *plight,unsigned char *psat,unsigned short *pc1,unsigned short *pc2,unsigned short *pc3,unsigned short *pshine) {
    // if (!isprite) return 0;
...
EXPORT int _get_player_sprite(int nr,int zdir,int action,int step,int duration,int attick) {
    int base;
...
EXPORT void _trans_csprite(int mn,struct map *cmap,int attick) {
...
EXPORT int _get_lay_sprite(int sprite,int lay) {
    switch (sprite) {
...
EXPORT int _get_offset_sprite(int sprite,int *px,int *py) {
    int x=0,y=0;
...
EXPORT int _additional_sprite(int sprite,int attick) {
    switch (sprite) {
...
EXPORT int _opt_sprite(int sprite) {
    switch (sprite) {
        case 13:
...
EXPORT int _no_lighting_sprite(int sprite) {
    switch (sprite) {
        case 21410:
        case 21411:
        case 21412:
